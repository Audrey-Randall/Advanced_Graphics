...
private:
   ...
   int     shaderIdx; //  Which shader we're using
   ...
   QVector<QString> shaderLocs; //shader file names of the form ":/shaderName" Leave off the .frag or .vert
public:
...
private:
   ...
   void listShaders();                     //  Initialize list of shaders
};
